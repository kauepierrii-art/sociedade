...
(function () {
  ...
  function renderTuner() {
    ...
    panel.innerHTML = `
      <img class="stage4-panel-art" src="assets/stage4/tuner-panel-v1.png" alt="Aparelho sintonizador de fita magnética" />
  ...
  const imagePanelStyle = document.createElement('style');
  imagePanelStyle.textContent = `
    .stage4-tuner{aspect-ratio:4/5;padding:0!important;border:0!important;border-radius:13px!important;background:#080807!important;overflow:hidden}.stage4-panel-art{position:absolute!important;inset:0!important;z-index:0;display:block;width:100%;height:100%;object-fit:cover}.stage4-tuner-head{position:absolute!important;z-index:1;top:2%;right:3%;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important;opacity:0}.stage4-switch-row{position:absolute!important;z-index:3;left:6%;top:43%;width:18%;height:29%;margin:0!important;padding:0!important;border:0!important;background:transparent!important}.stage4-switch-row p{display:none}.stage4-lever{width:100%;height:100%;gap:0}.stage4-lever-track{width:100%;height:100%;background:transparent!important;box-shadow:none!important}.stage4-lever-track:before,.stage4-lever-on,.stage4-lever-off{display:none}.stage4-lever-stick{left:42%;bottom:35%;height:33%;width:12%;background:transparent!important;box-shadow:none!important}.stage4-tuner.is-on .stage4-lever-stick{transform:translateY(-28%)!important}.stage4-knobs{position:absolute!important;z-index:3;left:29%;right:4%;top:42%;height:50%;padding:0!important;border:0!important;background:transparent!important;gap:1%}.stage4-knob{min-height:0!important;padding:0!important;background:transparent!important}.stage4-knob-label,.stage4-knob-hint{display:none!important}.stage4-knob-dial{width:100%!important;height:100%!important;margin:0!important}.stage4-knob-face{inset:15%!important;border:0!important;background:transparent!important;box-shadow:none!important}.stage4-knob-pointer{top:20%!important;left:calc(50% - 2px)!important;height:20%!important;background:#f4dca7!important;box-shadow:0 0 3px #000!important;transform-origin:50% 150%!important}.stage4-knob-scale-number{font-size:clamp(8px,2vw,12px)!important;color:#cba568!important;transform:rotate(var(--scale-angle)) translateY(-48px) rotate(calc(-1 * var(--scale-angle)))!important}.stage4-reel-window{position:absolute!important;z-index:2;left:6%;right:6%;top:6%;height:30%;margin:0!important;padding:0!important;border:0!important;background:transparent!important;box-shadow:none!important}.stage4-reel{width:38%!important;height:auto!important;aspect-ratio:1;border:0!important;background:transparent!important;box-shadow:none!important}.stage4-reel:before,.stage4-reel:after,.stage4-reel i,.stage4-tape-path,.stage4-window-screw{display:none!important}.stage4-led{position:absolute;z-index:4;left:12%;top:78%;width:4.2%;height:auto;aspect-ratio:1}.stage4-tuner-status{position:absolute;z-index:4;left:5%;right:5%;bottom:1%;margin:0!important;padding:0!important;border:0!important;background:rgba(4,10,8,.68);font-size:7px!important}.stage4-tuner:after{display:none}@media(max-width:390px){.stage4-knob-scale-number{font-size:8px!important;transform:rotate(var(--scale-angle)) translateY(-38px) rotate(calc(-1 * var(--scale-angle)))!important}}
  `;
  document.head.appendChild(imagePanelStyle);
})();
