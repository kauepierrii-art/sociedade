...
(function () {
  ...
  // Wide screens use the illustrated cabinet as a physical chassis. The live
  // controls are layered over its reserved panels, rather than baked into it.
  ...
  consoleStyle.textContent = `
    @media (min-width: 680px){
      .stage4-tuner{
        ...
        background:#080706 url("assets/stage4/tuner-console-texture.png") center / 100% 100% no-repeat!important;
        box-shadow:0 20px 34px rgba(0,0,0,.5)!important;
        overflow:visible;
      }
      .stage4-tuner:after{display:none}
      .stage4-reel-window{display:none}
      .stage4-tuner-head{
        position:absolute;
        z-index:2;
        top:7.3%; left:30%; right:30%;
        display:block;
        padding:0!important;
        border:0!important;
        border-radius:0!important;
      ...
      .stage4-tuner-head p{margin:0 0 12px!important;color:#d7ac67!important;font-size:clamp(7px,.82vw,12px)!important;letter-spacing:.22em!important}
      .stage4-tuner-head h3{color:#e6bb72!important;font-size:clamp(11px,1.23vw,18px)!important;letter-spacing:.18em!important;white-space:nowrap}
      .stage4-tuner-meta{
        position:absolute;
        top:60%; left:calc(100% + 22vw);
        display:flex;
        align-items:center;
        color:#bd9153!important;
        font-size:clamp(7px,.68vw,10px)!important;
        letter-spacing:.12em!important;
      }
      .stage4-led{width:14px!important;height:14px!important}
      .stage4-switch-row{
        position:absolute;
        z-index:3;
        top:32%; bottom:18.5%; left:5.1%; width:10.8%;
      ...
      .stage4-lever{width:100%!important;height:100%!important}
      .stage4-lever-track{width:70%!important;height:88%!important;background:transparent!important;box-shadow:none!important;border:0!important}
      .stage4-lever-track:before{left:27%!important;top:24%!important;width:45%!important;height:52%!important;background:#0b0806!important;border:1px solid #82613d!important;box-shadow:inset 0 0 8px #000!important}
      .stage4-lever-track:after{left:40%!important;top:29%!important;width:19%!important;height:41%!important;background:linear-gradient(90deg,#080604,#3e2a18,#080604)!important}
      .stage4-lever-on,.stage4-lever-off{left:7%!important;width:86%!important;font-size:clamp(8px,.85vw,12px)!important}
      .stage4-lever-on{top:5%!important}.stage4-lever-off{bottom:5%!important}
      .stage4-lever-stick{left:39%!important;bottom:29%!important;width:17%!important;height:29%!important}
      .stage4-tuner.is-on .stage4-lever-stick{transform:translateY(-83%)!important}
      .stage4-knobs{
        position:absolute;
        z-index:3;
        top:32%; bottom:17%; left:18%; right:18%;
        display:grid!important;
        grid-template-columns:repeat(2,1fr)!important;
        gap:0!important;
        padding:0!important;
      }
      .stage4-knob{min-height:0!important;padding:0!important}
      .stage4-knob-label{font-size:clamp(18px,2.1vw,30px)!important;line-height:1!important}
      .stage4-knob-dial{width:clamp(120px,15vw,190px)!important;height:clamp(120px,15vw,190px)!important;margin:2px auto 0!important}
      .stage4-knob-face{inset:22%!important;border-width:clamp(5px,.6vw,8px)!important}
      .stage4-knob-pointer{top:13%!important;height:27%!important;transform-origin:50% 39%!important}
      .stage4-knob-scale-number{font-size:clamp(10px,1vw,15px)!important;transform:rotate(var(--scale-angle)) translateY(clamp(-74px,-6.4vw,-50px)) rotate(calc(-1 * var(--scale-angle)))!important}
      .stage4-tuner-status{
        position:absolute;
        z-index:3;
        bottom:7.6%; left:35%; right:35%;
        min-height:0!important;
        margin:0!important;
        padding:6px 4px!important;
        border:0!important;
        color:#d6ad63!important;
        font-size:clamp(7px,.75vw,11px)!important;
        letter-spacing:.18em!important;
        white-space:nowrap;
      }
      .stage4-tuner:before{
        content:"ÁUDIO · CIÊNCIA · PROGRESSO · BRASIL";
        position:absolute; z-index:2;
        top:17%; left:5.4%; width:10%;
        color:#b38a52;
        font:clamp(7px,.67vw,10px)/2.25 Georgia,serif;
        letter-spacing:.12em;
        text-align:center;
      }
    }
    @media (max-width:679px){
      .stage4-tuner{border-color:#735331!important;box-shadow:inset 0 0 0 1px #c09252,inset 0 -16px 22px #080706,0 16px 26px rgba(0,0,0,.42)!important}
      .stage4-reel-window{border-color:#8d714e!important}
      .stage4-tuner-head{border-color:#75563a!important}
      .stage4-knobs{background:linear-gradient(118deg,#251b14,#110d0a 68%,#21170f)!important}
    }
  `;
