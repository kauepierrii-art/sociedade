...
(function () {
  ...
  function renderInvestigationArchive(target) {
    ...
    actions.innerHTML =
      '<section class="stage6-archive">' +
        ...
        '<article class="attachment-item stage6-historical-record"><button class="record-toggle stage6-document-toggle" type="button" aria-expanded="false"><span class="stage6-record-heading"><span>REGISTRO 01 — CONTEXTO DOCUMENTAL</span><span class="stage6-record-kicker">MATERIAL HISTÓRICO</span><span class="stage6-record-summary">Registros preservados sobre as práticas de John Dee e a fragmentação de seu conjunto documental.</span><span class="stage6-record-expand">Expandir para consultar o registro completo</span></span><span class="chev" aria-hidden="true">＋</span></button><div class="record-content" hidden><div class="archive-copy">' + paragraphs(historical) + '</div><p class="archive-sources">Referências: <a href="https://www.bl.uk/manuscripts/FullDisplay.aspx?ref=Sloane_MS_3188" target="_blank" rel="noopener">British Library</a> · <a href="https://hsm.ox.ac.uk/holy-table" target="_blank" rel="noopener">History of Science Museum</a> · <a href="https://www.britishmuseum.org/collection/object/H_1906-0922-1" target="_blank" rel="noopener">British Museum</a></p></div></article>' +
  ...
  style.textContent += `
    ...
    .stage6-record-heading{display:flex;flex:1;min-width:0;flex-direction:column;gap:8px}
