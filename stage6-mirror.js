...
(function () {
  ...
  function renderInvestigationArchive(target) {
    ...
    actions.innerHTML =
      '<section class="stage6-archive">' +
        ...
        '<div class="stage6-archive-intro"><p>No século XVI, John Dee registrou sessões nas quais afirmava receber comunicações de entidades espirituais. Seus relatos mencionam instruções, símbolos e objetos cerimoniais.</p><p>Parte desses registros sobreviveu. Outros materiais foram separados, copiados ou perdidos ao longo dos séculos.</p><p>O conjunto documental preservado pode ajudar a compreender a origem das referências encontradas nesta investigação.</p></div>' +
        '<article class="attachment-item stage6-historical-record"><button class="record-toggle stage6-document-toggle" type="button" aria-expanded="false"><span>REGISTRO 01 - CONTEXTO DOCUMENTAL</span><span class="chev" aria-hidden="true">＋</span></button><div class="record-content" hidden><div class="stage6-record-heading"><p class="stage6-record-kicker">MATERIAL HISTÓRICO</p><p class="stage6-record-summary">Registros preservados sobre as práticas de John Dee e a fragmentação de seu conjunto documental.</p><p class="stage6-record-expand">Expandir para consultar o registro completo</p></div><div class="archive-copy">' + paragraphs(historical) + '</div><p class="archive-sources">Referências: <a href="https://www.bl.uk/manuscripts/FullDisplay.aspx?ref=Sloane_MS_3188" target="_blank" rel="noopener">British Library</a> · <a href="https://hsm.ox.ac.uk/holy-table" target="_blank" rel="noopener">History of Science Museum</a> · <a href="https://www.britishmuseum.org/collection/object/H_1906-0922-1" target="_blank" rel="noopener">British Museum</a></p></div></article>' +
        '<article class="attachment-item"><button class="record-toggle" type="button" aria-expanded="false"><span>REGISTRO 02 — MATERIAL EM ANÁLISE</span><span class="chev">＋</span></button><div class="record-content" hidden><p class="doc-meta">DOCUMENTAÇÃO NÃO CATALOGADA · REFERÊNCIAS À SUPERFÍCIE ESCURA</p><div class="archive-copy">' + paragraphs(analysis) + '</div></div></article>' +
  ...
  `;
  style.textContent += `
    .stage6-archive-intro{margin:0 0 22px;padding:0 0 17px;border-bottom:1px solid var(--line);color:var(--text);font-size:14px;line-height:1.7}
    .stage6-archive-intro p{margin:0 0 12px}.stage6-archive-intro p:last-child{margin-bottom:0}
    .stage6-document-toggle{text-align:left;align-items:flex-start}
    .stage6-record-heading{display:flex;flex:1;min-width:0;flex-direction:column;gap:7px;margin:0 0 17px;padding:0 0 13px;border-bottom:1px solid var(--line)}
    .stage6-record-kicker{color:var(--amber);font-size:11px;letter-spacing:.09em}
    .stage6-record-summary{color:var(--text-soft);font:400 13px/1.6 Georgia,serif;letter-spacing:normal;text-transform:none}
    .stage6-record-expand{color:var(--text-soft);font-size:10px;font-weight:400;letter-spacing:.03em;text-transform:none}
    .stage6-document-toggle[aria-expanded="true"] .stage6-record-expand{display:none}
    .stage6-historical-record .archive-sources{margin-top:15px}
    @media(max-width:520px){.stage6-archive-intro{font-size:14px}.stage6-record-summary{font-size:12.5px}}
  `;
