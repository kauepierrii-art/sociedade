...
(function () {
  ...
  const runeSymbols = ['ᛉ','ᛋ','ᛜ','ᛏ','ᛇ','ᚫ','ᛞ','ᛖ','ᛃ','ᚹ','ᛒ','ᛝ','ᚲ','ᛟ'];
  ...
  style.textContent = [
    '.mirror-field{overflow:visible;margin:48px auto 60px}.mirror-hanger{position:absolute;z-index:0;top:-42px;left:calc(50% - 36px);width:72px;height:106px;border:2px solid #aaa094;border-bottom:0;border-radius:38px 38px 0 0;background:radial-gradient(circle at 50% 39%,#0a0a0a 0 14px,#8a8178 15px 17px,#050505 18px 27px,transparent 28px),linear-gradient(145deg,#181818,#030303 72%);box-shadow:inset 2px 1px 5px #6d665e,0 2px 5px #000}.mirror-rim{z-index:1;background:radial-gradient(circle at 38% 25%,#4a4a47,#111 11%,#030303 53%,#a19a90 79%,#111 81%,#020202 84%)!important;box-shadow:0 0 0 1px #cac1b4,0 0 0 4px #080808,0 18px 35px #000!important}.mirror-surface{z-index:2;background:radial-gradient(ellipse at 40% 22%,#252525 0,#050505 24%,#000 68%)!important;box-shadow:inset 0 0 40px #000,inset 0 0 2px #b8b0a4!important}.mirror-surface:after{content:"";position:absolute;inset:0;opacity:.42;background:repeating-linear-gradient(136deg,transparent 0 30px,rgba(232,232,225,.16) 31px,transparent 32px 77px),repeating-linear-gradient(33deg,transparent 0 46px,rgba(206,206,200,.13) 47px,transparent 48px 110px);mix-blend-mode:screen}.mirror-surface span{color:rgba(211,205,192,.35)!important}.mirror-rune{z-index:4;color:rgba(211,201,187,.72)!important;font-family:Georgia,serif!important;font-size:37px!important;text-shadow:0 1px 1px #000}.mirror-base{position:absolute;z-index:0;left:7%;right:7%;bottom:-45px;height:34px;border:2px solid #353535;border-radius:2px;background:linear-gradient(180deg,#232323,#050505 58%,#171717);box-shadow:0 4px 8px #000, inset 0 1px #777}.mirror-base:before{content:"";position:absolute;left:calc(50% - 18px);bottom:30px;width:36px;height:37px;border:2px solid #5b5b57;border-bottom:0;border-radius:4px 4px 0 0;background:linear-gradient(90deg,#101010,#3c3c39,#0b0b0b);box-shadow:0 -1px 5px #000}.mirror-base:after{content:"";position:absolute;top:7px;left:5%;right:5%;height:1px;background:rgba(214,208,195,.46)}.mirror-protocol-link a{color:inherit;text-decoration:none;cursor:pointer;transition:opacity .2s,text-shadow .2s}.mirror-protocol-link a:hover{opacity:1;text-shadow:0 0 9px rgba(115,224,201,.48)}',
