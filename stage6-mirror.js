...
(function () {
  ...
  style.textContent = [
    '.mirror-field{overflow:visible;margin:30px auto 48px}.mirror-hanger{position:absolute;z-index:0;top:-25px;left:calc(50% - 26px);width:52px;height:68px;border:1px solid #7f7a72;border-bottom:0;border-radius:28px 28px 0 0;background:radial-gradient(circle at 50% 40%,#111 0 10px,#777168 11px 12px,#080808 13px 20px,transparent 21px),linear-gradient(145deg,#141414,#030303 72%);box-shadow:inset 1px 1px 3px #625d55,0 2px 4px #000}.mirror-rim{z-index:1;background:#030303!important;box-shadow:0 18px 35px #000!important}.mirror-surface{z-index:2;inset:0!important;background:radial-gradient(ellipse at 40% 22%,#202020 0,#040404 26%,#000 70%)!important;box-shadow:inset 0 0 38px #000!important}.mirror-surface:after{display:none}.mirror-surface span{color:rgba(211,205,192,.35)!important}.mirror-rune{z-index:4;color:rgba(211,201,187,.72)!important;font-family:Georgia,serif!important;font-size:37px!important;text-shadow:0 1px 1px #000}.mirror-base{position:absolute;z-index:3;left:7%;right:7%;bottom:-28px;height:29px;border:1px solid #343434;border-radius:2px;background:linear-gradient(180deg,#202020,#050505 58%,#151515);box-shadow:0 4px 8px #000,inset 0 1px #676767}.mirror-base:before{display:none}.mirror-base:after{content:"";position:absolute;top:6px;left:5%;right:5%;height:1px;background:rgba(214,208,195,.36)}.mirror-protocol-link a{color:inherit;text-decoration:none;cursor:pointer;transition:opacity .2s,text-shadow .2s}.mirror-protocol-link a:hover{opacity:1;text-shadow:0 0 9px rgba(115,224,201,.48)}',
